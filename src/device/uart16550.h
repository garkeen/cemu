#ifndef CEMU_DEVICE_UART16550_H
#define CEMU_DEVICE_UART16550_H
...
// device is wired to it yet) and the interrupt line is not connected until a
// PIC exists; LSR therefore never reports data ready.
